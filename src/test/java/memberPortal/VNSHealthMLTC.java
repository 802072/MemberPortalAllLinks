...
public class VNSHealthMLTC extends BaseTest {
	...
	public void homePage() throws InterruptedException, IOException {
		...
		clickElement("HP0113", "homePage", hPlan);
		// Click Close
		clickElement("HP0114", "homePage", hPlan);
	}
	...
	public void benefits() throws InterruptedException, IOException {
		...
		clickElementChildWindow("BE0103", "benefitsMenu", hPlan);
		// Click Member Handbook link
		clickElementChildWindow("BE0104", "benefitsMenu", hPlan);
		// Click Healthplex
	...
	public void myPlanResources() throws InterruptedException, IOException {
		...
		clickElementChildWindow("RE0105", "resourcesMenu", hPlan);
		// Click Member Materials and Forms Link
		clickElementChildWindow("RE0106", "resourcesMenu", hPlan);
