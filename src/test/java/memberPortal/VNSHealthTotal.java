...
public class VNSHealthTotal extends BaseTest_AllLinks {
	...
	public void initializeReport() {
		initialiseExtentReports("MemberPortalAutomationTotal.html",
				"Member Portal: VNS Health Total Plan Automation Report");
	}
	...
	public void benefits() throws InterruptedException, IOException {
		...
		openChildWindowVerifyTitle("BE0112", "benefitsMenu", colNum);
		// Click Rewards Link
	...
	public void flexCard() throws InterruptedException, IOException {
		...
		openChildWindowVerifyTitle("BE0503", "benefitsMenu", colNum);
		// Click Flex Card Link
		openChildWindowVerifyTitle("BE0504", "benefitsMenu", colNum);
	}
	...
	public void myPlanResources() throws InterruptedException, IOException {
		...
		// Click Flex Card Link
		openChildWindowVerifyTitle("RE0109", "resourcesMenu", colNum);
		// Click OTC and Grocery Card Link
	...
	public void benefitPartners() throws InterruptedException, IOException {
		...
		// Click Flex Card Link
		openChildWindowVerifyTitle("RE0208", "resourcesMenu", colNum);
		// Click Rewards Link
